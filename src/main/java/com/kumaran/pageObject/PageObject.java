...
import com.kumaran.helper.WaitHelper;
...
public class PageObject {
	...
	public void enterFromValue(String fromPlace) {
		// driver.findElement(By.xpath("//input[@placeholder='From']")).sendKeys("Che");
		this.chooseFrom.sendKeys(fromPlace);
	}
	...
	public void selectFrom() throws InterruptedException {
		...
		for (WebElement e : ele) {
			...
			if (e.getText().equals("Tiruchirapalli, India"))
				;
			e.click();
		}
	}
	...
	public void enterToValue(String toPlace) {
		// driver.findElement(By.cssSelector("input[placeholder='To']")).sendKeys("Bid");
		this.chooseTo.sendKeys(toPlace);
	}
	...
	public void chooseDepatureDate() throws InterruptedException {
		WaitHelper.timeOut();
		this.depatureDate.click();
		// driver.findElement(By.cssSelector("div[aria-label='Thu Feb 16
		// 2023']")).click();
	}
...
//				.click();
	...
	public void chooseReturnDate() {
		// driver.findElement(By.cssSelector("div[aria-label='Wed Mar 15
		// 2023']")).click();
	...
	public void fare_type() {
		...
		// driver.findElement(By.xpath("//div[@class='makeFlex
		// hrtlCenter']//li[1]")).click();
